...
<style>
	...
	.jzlist{ border-collapse: collapse; border-spacing: 0;margin: 0 auto;width: 100%;}
	.jzlist thead{background-color: #F08080;}
	.jzlist th,.jzlist td{    border: 1px solid #DFDFDF;font-weight: normal;}
...
<body>
	...
	<div class="sycontent">
		...
		<div style="width: 93%;margin:0 auto;padding: 15px;">
			<table class="jzlist">
				<thead>
					<tr>
						<th>捐赠人</th>
