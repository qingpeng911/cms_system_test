...
<body>
	...
	<div class="sycontent">
		...
		<div class="kaic bdright">
			...
			<p style="text-indent: 2em;">通俗来说，其实就是帮助你以最便捷的方式将各种类型的数据规范入库，尽可能少写代码，越少越好，做到极致，功能及页面都靠配置来完成，且能够即时修改即时显示，再配合一些工具及技巧就极大地提升了效率。cms只管后台的数据入库，显示由前台负责，因此可互不干扰同步开发。具体参见教程。</p>
		</div>
		<div class="kaic" >
			...
			<p>3、极简设计。提倡减法，设计思路类似RISC，只保留构成cms基本功能所必须的参数，避免动辄一堆复杂输入的表单，怎么方便怎么来，极大地方便了二次开发。</p>
